public class ProgramMayagud {
    public static void main(String[] args) {
        Kedja<Mayagud> gudar = new Kedja<>();
        gudar.addInOrder(new Mayagud("Chaac", "Regn och åska", "Chaac är mestadels en grupp åskgudar med anknytning till regn i mayaindianernas mytologi." +
        ...
        if(gudar.contains(new Mayagud("Hunahpu"))){
            System.out.println("Hittades!");
        } else {
            System.out.println("Fanns inte!");
        }

        if(gudar.contains(new Mayagud("Itzamna"))){
            System.out.println("Hittades!");
        } else {
            System.out.println("Fanns inte!");
        }
